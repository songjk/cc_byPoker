...
-(BOOL) isBeforeDays:(NSInteger)days{
    NSDate *myself = [self dateAtStartOfDay];
    NSDate *nowDate = [[NSDate date] dateAtStartOfDay];
    NSTimeInterval secs = [nowDate timeIntervalSinceDate:myself];
    
    NSInteger betweenDay = secs/D_DAY;
